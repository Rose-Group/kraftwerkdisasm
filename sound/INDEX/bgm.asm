...
BGM_05:		include	"bgm/05 - Stage 1-4.asm"
BGM_06:		include	"bgm/06 - Stage 13.asm"
BGM_07:		include	"bgm/07 - Stage 9-12.asm"
BGM_08:		include	"bgm/08 - Victory.asm"
BGM_09:		include	"bgm/09 - Unused (Game Over).asm"
BGM_0A:		include	"bgm/0A - Role Call.asm"
BGM_0B:		include	"bgm/0B - Credits.asm"
...
BGM_15:		include	"bgm/15 - Unused (Alt Ending).asm"
BGM_16:		include	"bgm/16 - Stage 9-12 Cutscene.asm"
BGM_17:		include	"bgm/17 - Stage 1-4 Cutscene.asm"
BGM_18:		include	"bgm/18 - Stage 5-8 Cutscene.asm"
		include	"bgm/Unused SFX.asm"
